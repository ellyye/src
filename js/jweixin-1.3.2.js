console.log("执行前",wx,jWeixin)
! function(e, n) {
	"function" == typeof define && (define.amd || define.cmd) ? define(function() {
		return n(e)
	}) : n(e, !0)
	// 是否添加wx对象，判断当前环境？小程序环境or普通浏览器环境？
	console.log("function" == typeof define && (define.amd || define.cmd));
}(this, function(e, n) {
	function i(n, i, t) {
	...
	if (!e.jWeixin) {
		...
		var E = !1,
			...
			R = {};
			// console.log("wx对象",N);
			// console.log("n:"+n,"n为true，添加wx对象到window上");
